        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="{{route('distritos.index')}}">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-map-pin"></i></i></div>
                            Distritos
                        </a>
                        @endauth
                        @auth('repartidor')
                        ...
                        <a class="nav-link" href="{{route('transporte.index')}}">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-check"></i></div>
                            Asignar Paquetes
                        </a>

                        <a class="nav-link" href="{{route('transporte.general')}}">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-box-open"></i></div>
                            Todos los Paquetes
                        </a>
                        ...
                        <div class="sb-sidenav-menu-heading">REPARTIDORES</div>
                        <a class="nav-link" href="{{route('cuentasrepartidores.index')}}">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-truck-fast"></i></div>
                            Ver Repartidores
                        </a>

                        <a class="nav-link" href="{{route('cuentasrepartidores.create')}}">
                ...
                <div class="sb-sidenav-footer">
                    ...
                    {{ auth('repartidor')->user()->nombre }}
                    @elseif(auth('proveedor')->check())
                    {{ auth('proveedor')->user()->nombre }}
                    @endif
                </div>
            </nav>
        </div>
            ...
            <main>
                ...
                <div class="container w-100 border border-3 border-primary rounded p-4 mt-3">
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="number" name="cobrar" id="cobrar" class="form-control" step="0.01" value="{{old('cobrar')}}">
                            @error('cobrar')
                            <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div>
                        ...
                        {{-- Nuevo campo para NOTA (usando textarea, es más común para notas largas) --}}
                        <div class="row g-3">
                            <div class="col-md-6">
                        ...
                        {{-- Nuevo campo para FECHA (tipo 'date' para un selector de fecha) --}}
                        <div class="row g-3">
                            <div class="col-md-6">
                        ...
                        {{-- Nuevo campo para LINK_DIREC --}}
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="link_direc" class="form-label">Link Dirección:</label>
                                <input type="text" name="link_direc" id="link_direc" class="form-control" value="{{old('link_direc')}}">
                                @error('link_direc')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
