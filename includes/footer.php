...
<footer class="bg-gray-900 text-white pt-12 pb-6 mt-10">
    <div class="max-w-screen-xl mx-auto px-5 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm">
                <li>
                    <a href="index.php" class="hover:text-[#ff7947] transition">Inicio</a>
                </li>
                <li>
                    <a href="cotizar.php" class="hover:text-[#ff7947] transition">Cotizar</a>
                </li>
                <li>
                    <a href="seguimiento.php" class="hover:text-[#ff7947] transition">Seguimiento</a>
                </li>
                <li>
                    <a href="contacto.php" class="hover:text-[#ff7947] transition">Contacto</a>
                </li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm">
                <li class="flex items-center gap-2">
                    <i class="bi bi-telephone text-[#ff7947]"></i>
                    <span>+51 987 654 321</span>
                </li>
                <li class="flex items-center gap-2">
                    <i class="bi bi-envelope text-[#ff7947]"></i>
                    <span>contacto@xpress.com</span>
                </li>
                <li class="flex items-center gap-2">
                    <i class="bi bi-geo-alt text-[#ff7947]"></i>
                    <span>Lima, Perú</span>
                </li>
            </ul>
        </div>
    ...
    <div class="border-t border-gray-700 mt-10 pt-6 text-center text-sm text-gray-400">
        © <?php echo date("Y"); ?> XPRESS. Todos los derechos reservados.
    </div>
</footer>
